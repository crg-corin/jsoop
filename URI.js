...
(function (w) {
    ...
    function URI(str) {
        ...
        str = String(str || window.location);
...
(function (w) {
  ...
  /**
  URI.parseQueryString = function parseQueryString(q) {
    var e, o, r, a, b, n, v;
    q = q ? String(q) : ''; //sanitize query
    e = /(?:^\?|^|\&)(([^\&=\?]+)(?:=([^\&]*))?)(?=\&|$)/g;
    o = {};
    while (r = e.exec(q)) {
      a = r[2];
      b = r[3];
      n = a ? decodeURIComponent(a) : '';
      v = b ? decodeURIComponent(b) : '';
